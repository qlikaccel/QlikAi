...
def test_api_endpoints():
    ...
    try:
        ...
        # base_url = "https://qlikaiv2.onrender.com"
...
def main():
    ...
    if passed == total:
        ...
        # logger.info("2. Test endpoint: curl -X POST https://qlikaiv2.onrender.com/api/migration/full-pipeline?app_id=YOUR_APP_ID")
